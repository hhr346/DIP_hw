...
def train_one_epoch(model, dataloader, optimizer, criterion, device, epoch, num_epochs, epoch_train_losses):
    """
    ...
    for i, (image_rgb, image_semantic) in enumerate(dataloader):
        ...
        if (epoch+1) % 50 == 0 and i == 0:
            save_images(image_rgb, image_semantic, outputs, 'train_results', epoch+1)
...
def validate(model, dataloader, criterion, device, epoch, num_epochs, epoch_val_losses):
    """
...
def main():
    ...
    for epoch in range(num_epochs):
        train_one_epoch(model, train_loader, optimizer, criterion, device, epoch, num_epochs, epoch_train_losses)
        validate(model, val_loader, criterion, device, epoch, num_epochs, epoch_val_losses)
